...
[<strong>2017</strong>] Bachelor,  Physics, University of Padua, Italy<br>
[<strong>2019</strong>] Master,  Physics, University of Padua, Italy<br>
...
<div style="display: flex; justify-content: center; gap: 30px;">
  ...
  <figure style="text-align: center; width: 30%; margin: 0;">
    <img src="assets/img/mainz.jpg" alt="Mainz" style="width: 100%; border-radius: 4px;">
    <figcaption style="font-size: 0.9em; color: gray; margin-top: 5px;">17th Patras workshop <strong>@JGU</strong><br>Mainz, Germany<br>2022</figcaption>
  </figure>

  <figure style="text-align: center; width: 30%; margin: 0;">
    <img src="assets/img/gadi.jpg" alt="Gadi" style="width: 100%; border-radius: 4px;">
    <figcaption style="font-size: 0.9em; color: gray; margin-top: 5px;">Gadi HPC <strong>@NCI</strong><br>Canberra, Australia<br>2023</figcaption>
  </figure>

  <figure style="text-align: center; width: 30%; margin: 0;">
    <img src="assets/img/uwa.jpg" alt="UWA" style="width: 100%; border-radius: 4px;">
    <figcaption style="font-size: 0.9em; color: gray; margin-top: 5px;">Quantum Dark Matter Lab <strong>@UWA</strong><br>Perth, Australia<br>2025</figcaption>
  </figure>
